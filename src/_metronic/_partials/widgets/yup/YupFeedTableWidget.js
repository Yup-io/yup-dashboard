...
class YupFeedTableWidget extends Component {
	...
	async updateData(page, limit) {
		let [ createVoteV3, postVoteV2 ] = await Promise.all([
			this.getCreateVoteV3(0, limit),
			this.getPostVoteV2(0, limit)
		]);
				...
				<div className={`card card-custom card-stretch gutter-b`}>
					...
					<div className="card-body pt-0 pb-3">
												...
												<tr key={item.vote.global_sequence}>
													...
													<td>
														<span className="text-dark-75 text-left d-block font-size-lg">
															{item.post.tag.split('.')[0].charAt(0).toUpperCase() +
						...
						<Pagination className="float-right" size="lg">
							...
							<Pagination.Item active={this.state.page === 1} onClick={() => this.updateData(1, 50)}>
								{1}
							</Pagination.Item>
							<Pagination.Item active={this.state.page === 2} onClick={() => this.updateData(2, 50)}>
								{2}
							</Pagination.Item>
							<Pagination.Item active={this.state.page === 3} onClick={() => this.updateData(3, 50)}>
								{3}
							</Pagination.Item>
							<Pagination.Item active={this.state.page === 4} onClick={() => this.updateData(4, 50)}>
								{4}
							</Pagination.Item>
							<Pagination.Item active={this.state.page === 5} onClick={() => this.updateData(5, 50)}>
								{5}
							</Pagination.Item>
